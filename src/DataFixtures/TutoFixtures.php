...
class TutoFixtures extends Fixture
{
    public const TUTO = [
        ...
        'picture' => 'assets/images/sapin.jpg'
        ],
        1 => [
            ...
            'picture' => 'assets/images/sapin_palette.jpg'
        ],
        2 => [
            ...
            'picture' => 'assets/images/sapin_planche.jpg'
        ],
    ];
...
//            $tuto->setCategory($this->getReference('category_0'));
